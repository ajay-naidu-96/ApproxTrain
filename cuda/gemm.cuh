...
#ifdef AMSIMULATOR
#define MULTIPLY(a, b)                                                         \
  AMsimulator((a), (b), mant_lut, mant_mask, a_shift, b_shift, mant_bitwidth);
...
__global__ void gemm(size_t m, size_t n, size_t k, const T *a, size_t lda,
                     ...
                     cudaTextureObject_t mant_lut, uint32_t mant_mask,
                     uint8_t a_shift, uint8_t b_shift, uint8_t mant_bitwidth) {
  T value(0);
